...
hw_mgmt_id_dict = {
    130: 0, # x86_64-mlnx_mqm9700-r0
    152: 0, # arm64-nvidia_mqm9700-r0
    158: 1, # x86_64-nvidia_qm3000-r0 and x86_64-nvidia_q3400_ra-r0
    157: 2, # x86_64-nvidia_qm3400-r0 and x86_64-nvidia_q3200_ra-r0
    167: 3, # x86_64-nvidia_n5110_ld-r0
}
...
class SfpUtil(SfpUtilBase):
    ...
    def get_port_position_tuple_by_platform_name(self):
        hw_mgmt_id = device_info.get_system_hw_mgmt_id()
        position_tuple = port_position_tuple_list[hw_mgmt_id_dict[hw_mgmt_id]]
    ...
    def get_low_power_mode(self, port_num):
        ...
        lpm_cmd = ["docker", "exec", "syncd-ibv0", "python", "/usr/share/sonic/platform/plugins/sfplpmget.py", str(port_num)]
    ...
    def set_low_power_mode(self, port_num, lpmode):
        ...
        lpm_cmd = ["docker", "exec", "syncd-ibv0", "python", "/usr/share/sonic/platform/plugins/sfplpmset.py", str(port_num), lpm]
    ...
    def reset(self, port_num):
        ...
        lpm_cmd = ["docker", "exec", "syncd-ibv0", "python", "/usr/share/sonic/platform/plugins/sfpreset.py", str(port_num)]
